...
const removeAllUserElements = () => document.querySelector('#users-wrapper').innerHTML = "";

const getReadySign = ready => (ready ? '🟢' : '🔴');

export { appendUserElement, changeReadyStatus, setProgress, removeUserElement, removeAllUserElements };
