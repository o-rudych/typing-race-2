...
const removeAllRoomElements = () => document.querySelector('#rooms-wrapper').innerHTML = "";

export { appendRoomElement, updateNumberOfUsersInRoom, removeRoomElement, removeAllRoomElements };
